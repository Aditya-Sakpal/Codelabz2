...
export const addComment =
  (type, comment) => async (firebase, firestore, dispatch) => {
    try {
      ...
      if (type == "comment") {
        const tutorialData = await getTutorialData(comment.tutorial_id)(
          firebase,
          firestore,
          dispatch
        );
        ...
        const newReplies = await getCommentReply(comment.replyTo)(
          firebase,
          firestore,
          dispatch
        );
